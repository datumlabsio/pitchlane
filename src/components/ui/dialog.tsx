  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          // Desktop default is lg (512px) — sm (384px) crushed any dialog with a
          // two-column form. Callers widen further with an `sm:`-prefixed max-w
          // (an unprefixed max-w-* would lose to this responsive variant).
